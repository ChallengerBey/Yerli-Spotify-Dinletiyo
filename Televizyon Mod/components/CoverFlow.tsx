...
const CoverFlow: React.FC<CoverFlowProps> = ({ data, currentIndex, isPlaying, onIndexChange, onNext, onPrev }) => {
        ...
        {data.map((item, index) => {
          ...
          return (
            <div
              ...
              className={`absolute w-48 h-48 sm:w-56 sm:h-56 transition-all duration-[900ms] cubic-bezier(0.2, 0.8, 0.2, 1) cursor-pointer select-none group 
