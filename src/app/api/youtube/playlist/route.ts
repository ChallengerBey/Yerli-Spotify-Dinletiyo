                ...
                if (obj.playlistVideoRenderer) {
                    ...
                    if (v.videoId) {
                        ...
                        list.push({
                            ...
                            imageUrl: v.thumbnail?.thumbnails?.[0]?.url || `https://i.ytimg.com/vi/${v.videoId}/maxresdefault.jpg`,
                ...
                // YouTube Music Track (Eğer WEB_REMIX gelirse veya yapı farklıysa)
                    ...
                    if (videoId) {
                        ...
                        list.push({
                            ...
                            album: 'YouTube Music',
                            duration: '',
                            imageUrl: v.thumbnail?.musicThumbnailRenderer?.thumbnail?.thumbnails?.[0]?.url || `https://i.ytimg.com/vi/${videoId}/maxresdefault.jpg`,
                            audioUrl: videoId,
                            aiHint: 'youtube'
                        });
                    }
