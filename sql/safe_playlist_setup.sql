-- ============================================
-- SAFE PLAYLIST SETUP - Only creates missing items
-- ============================================
...
BEGIN
    IF NOT EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'playlists') THEN
        ...
        RAISE NOTICE 'Created playlists table';
    ELSE
...
BEGIN
    IF NOT EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'playlist_songs') THEN
        ...
        RAISE NOTICE 'Created playlist_songs table';
    ELSE
...
BEGIN
    IF NOT EXISTS (
        ...
        WHERE tablename = 'playlists' AND rowsecurity = true
    ) THEN
        ALTER TABLE public.playlists ENABLE ROW LEVEL SECURITY;
        RAISE NOTICE 'Enabled RLS for playlists table';
    END IF;
    
    IF NOT EXISTS (
        SELECT 1 FROM pg_tables 
        WHERE tablename = 'playlist_songs' AND rowsecurity = true
    ) THEN
        ALTER TABLE public.playlist_songs ENABLE ROW LEVEL SECURITY;
        RAISE NOTICE 'Enabled RLS for playlist_songs table';
    END IF;
END $$;
...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        RAISE NOTICE 'Created policy: Users can view their own playlists';
    END IF;
    ...
    IF NOT EXISTS (
        ...
        RAISE NOTICE 'Created policy: Users can view public playlists';
    END IF;
    ...
    IF NOT EXISTS (
        ...
        RAISE NOTICE 'Created policy: Users can create their own playlists';
    END IF;
    ...
    IF NOT EXISTS (
        ...
        CREATE POLICY "Users can update their own playlists"
            ...
            USING (auth.uid() = user_id);
        RAISE NOTICE 'Created policy: Users can update their own playlists';
    END IF;
    ...
    IF NOT EXISTS (
        ...
        CREATE POLICY "Users can delete their own playlists"
            ...
            USING (auth.uid() = user_id);
        RAISE NOTICE 'Created policy: Users can delete their own playlists';
    END IF;
    ...
    IF NOT EXISTS (
        ...
        RAISE NOTICE 'Created policy: Users can view songs in their playlists';
    END IF;
    ...
    IF NOT EXISTS (
        ...
        RAISE NOTICE 'Created policy: Users can view songs in public playlists';
    END IF;
    ...
    IF NOT EXISTS (
        ...
        RAISE NOTICE 'Created policy: Users can add songs to their playlists';
    END IF;
    ...
    IF NOT EXISTS (
        ...
        RAISE NOTICE 'Created policy: Users can update songs in their playlists';
    END IF;
    ...
    IF NOT EXISTS (
        ...
        RAISE NOTICE 'Created policy: Users can delete songs from their playlists';
    END IF;
END $$;
...
BEGIN
    ...
    ELSE
        RAISE NOTICE 'Trigger trigger_update_playlist_stats already exists';
    END IF;
END $$;
...
BEGIN
    ...
    RAISE NOTICE 'All playlist tables, policies, and triggers are now ready!';
    RAISE NOTICE 'You can now create and manage playlists.';
END $$;